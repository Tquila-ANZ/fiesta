	...
	render() {
		return (
			...
			<View style={{flexDirection: 'row', flex: 1}}>
				...
				<View><Text>{this.props.data["FirstName"]}</Text></View>
				<View><Text>Surname</Text></View>
				<View><Text>{this.props.data["LastName"]}</Text></View>
				</View>
				<Hr />
				<View style={{flexDirection: 'row', flex: 1}}>
				<View><Text>Gender</Text></View>
				<View><Text>{this.props.data["Gender__c"]}</Text></View>
				<View><Text>Date of Birth</Text></View>
				<View><Text>{this.props.data["Date_of_Birth__c"]}</Text></View>
				</View>
				<Hr />
				<View><Text>mobile</Text></View>
				<View><Text>{this.props.data["MobilePhone"]}</Text></View>
			</View>
		);
	}
}
